...
if (!Object.keys(window.userSettings).includes("s2s_components")) { // For backwards compatibility
    window.userSettings.s2s_components = {
        pitch: {
            enabled: true,
            strength: 0.75
        },
...
// Pitch
s2s_components_pitch_enabled.checked = window.userSettings.s2s_components.pitch.enabled
s2s_components_pitch_range.value = window.userSettings.s2s_components.pitch.strength
s2s_components_pitch_strength.value = window.userSettings.s2s_components.pitch.strength
s2s_components_pitch_enabled.addEventListener("change", () => {
    window.userSettings.s2s_components.pitch.enabled = s2s_components_pitch_enabled.checked
    saveUserSettings()
})
s2s_components_pitch_range.addEventListener("input", () => {
    const value = parseFloat(s2s_components_pitch_range.value)
    window.userSettings.s2s_components.pitch.strength = value
    s2s_components_pitch_strength.value = value
    saveUserSettings()
})
s2s_components_pitch_strength.addEventListener("input", () => {
    const value = parseFloat(s2s_components_pitch_strength.value)
    s2s_components_pitch_range.value = value
    window.userSettings.s2s_components.pitch.strength = value
    saveUserSettings()
})
// Duration
s2s_components_durations_enabled.checked = window.userSettings.s2s_components.durations.enabled
s2s_components_durations_range.value = window.userSettings.s2s_components.durations.strength
s2s_components_durations_strength.value = window.userSettings.s2s_components.durations.strength
s2s_components_durations_enabled.addEventListener("change", () => {
    window.userSettings.s2s_components.durations.enabled = s2s_components_durations_enabled.checked
    saveUserSettings()
})
s2s_components_durations_range.addEventListener("input", () => {
    const value = parseFloat(s2s_components_durations_range.value)
    window.userSettings.s2s_components.durations.strength = value
    s2s_components_durations_strength.value = value
    saveUserSettings()
})
s2s_components_durations_strength.addEventListener("input", () => {
    const value = parseFloat(s2s_components_durations_strength.value)
    s2s_components_durations_range.value = value
    window.userSettings.s2s_components.durations.strength = value
    saveUserSettings()
})
// Energy
s2s_components_energy_enabled.checked = window.userSettings.s2s_components.energy.enabled
s2s_components_energy_range.value = window.userSettings.s2s_components.energy.strength
s2s_components_energy_strength.value = window.userSettings.s2s_components.energy.strength
s2s_components_energy_enabled.addEventListener("change", () => {
    window.userSettings.s2s_components.energy.enabled = s2s_components_energy_enabled.checked
    saveUserSettings()
})
s2s_components_energy_range.addEventListener("input", () => {
    const value = parseFloat(s2s_components_energy_range.value)
    window.userSettings.s2s_components.energy.strength = value
    s2s_components_energy_strength.value = value
    saveUserSettings()
})
s2s_components_energy_strength.addEventListener("input", () => {
    const value = parseFloat(s2s_components_energy_strength.value)
    s2s_components_energy_range.value = value
    window.userSettings.s2s_components.energy.strength = value
    saveUserSettings()
})
